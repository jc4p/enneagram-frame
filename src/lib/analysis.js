...
const personalitySchema = {
  ...
  properties: {
    ...
    supportingEvidence: {
      ...
      items: {
        ...
        properties: {
          ...
          phrases: {
            type: SchemaType.ARRAY,
            description: "Exactly 3 short phrases from their casts demonstrating this pattern",
            items: { 
              type: SchemaType.STRING,
    ...
    whyNotOtherTypes: {
      type: SchemaType.ARRAY,
      description: "The 3 most likely alternative types that were considered but rejected",
      items: {
        type: SchemaType.OBJECT,
        properties: {
          ...
          reason: { 
            type: SchemaType.STRING,
            description: "Clear explanation why this type doesn't fit (always use 'Type X' not 'type x' when referencing types)",
            maxLength: 150,
          },
        },
      },
